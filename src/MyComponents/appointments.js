  ...
  return (
    <div className="main">
      ...
      <div className="modal hidden">
        ...
        <p id="instruction">Available Doctors</p>
        <ul id="doctors">
          <li
            onClick={() => {
          ...
          >
            Dr. Ashutosh Sharma (Cardiologist)
          </li>
          <li>Dr. Salman Yusuf (General Physician)</li>
        </ul>
      </div>
      <div className="modal1 hidden">
        <button
          className="close-modal"
          onClick={() => {
            navigate("/dashboard");
        ...
        <p id="instruction">Appointment Booked Successfully</p>
      </div>
