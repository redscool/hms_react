    ...
    <div className="main">
      ...
      <div className="right-form">
        ...
        <div className="pagetitlediv">
          <label className="pagetitle">Add Patient Details</label>
        </div>
        ...
        <div className="patient-form">
          ...
          <div className="section-2">
            ...
            <div className="input-field">
              ...
              <input className="occupation input1"></input>
            </div>
            <div className="input-field">
              <label className="insurer label">Insurer</label>
              <select className="insurer input1">
                <option value="item-1">Bajaj Allianz General Insurance</option>
                <option value="item-2">Max Bupa Health Insurance</option>
                <option value="item-3">Navi Health Insurance</option>
                <option value="item-4">National Insurance Company </option>
                <option value="item-5">Star Health Insurance </option>
              </select>
            </div>
          </div>
        </div>
        <div>
          <button
            ...
            onClick={() => {
              const modal = document.querySelector(".modal");
              const overlay = document.querySelector(".overlay");
              showModal(modal, "Patient Added Successfully");
              showModal(overlay, "Patient Added Successfully");
              // navigate("/dashboard");
            }}
          >
            Submit
